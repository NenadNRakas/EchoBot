...
namespace Microsoft.BotBuilderSamples.Bots
{
    public class EchoBot : ActivityHandler
    {
        readonly string welcomeText =
                "Welcome, my name is Louis, I am an A.i. ChatBot I will not be able to teach you, " +
                "but I can definitely help! Feel free to ask me about different countries and their capitals. " +
                "If not sure, start with **Help**";
        
        readonly string unknownText = "I am not sure I understand. If you are not sure what to say, type the word <help>?";
